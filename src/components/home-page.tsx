...
export function HomePage() {
  ...
  return <main>
    ...
    <section className="social-section"><div className="container"><div className="section-heading"><div><span className="eyebrow light">From the feed</span><h2>WHAT’S<br/><em>HAPPENING NOW.</em></h2></div><p>Launches, warehouse moments, retailer wins, and the products moving through Hi-Five this week—managed directly by the content team.</p></div><div className="social-feed"><article className="social-hero"><span>@hifivesupply · New catalog</span><h3>CHEWBIES<br/>JUST LANDED.</h3><small>Six flavors · Manufacturer media and COAs loaded</small></article><article><span>Brand assortment</span><div className="social-orb">3</div><h3>Chewbies, NTRL, and Realize Hemp.</h3></article><article><span>Buyer portal</span><b>Product galleries and compliance documents are ready to review.</b><small>Approved wholesale access only</small></article></div></div></section>
